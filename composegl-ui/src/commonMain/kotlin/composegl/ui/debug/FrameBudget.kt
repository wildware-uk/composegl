...
class FrameBudget(
    ...
    /** Times the Compose runtime's own work: everything [composegl.ui.host.UiHost.frame] does. */
     ...
     *   [composegl.ui.graphics.UiCanvas.drawCalls] is where it comes from.
