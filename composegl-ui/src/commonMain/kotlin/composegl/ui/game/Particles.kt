 ...
 *
 * A drawing widget rather than a [composegl.ui.modifier.effect], and the difference is what it is
 ...
 * finished is a boolean a frame and nothing else. Put a [composegl.ui.modifier.effect] on the
