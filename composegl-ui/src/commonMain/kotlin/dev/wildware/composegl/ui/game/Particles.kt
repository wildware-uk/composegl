 ...
 *
 * A drawing widget rather than a [dev.wildware.composegl.ui.modifier.effect], and the difference is what it is
 ...
 * finished is a boolean a frame and nothing else. Put a [dev.wildware.composegl.ui.modifier.effect] on the
