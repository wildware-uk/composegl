...
interface UiCanvas {
     ...
     * [uk.wildware.composegl.ui.host.UiRenderer]. Every backend that draws to a screen has this pair anyway:
     ...
     *
     * Here, rather than on each backend, so that [uk.wildware.composegl.ui.debug.FrameBudget] can show the
