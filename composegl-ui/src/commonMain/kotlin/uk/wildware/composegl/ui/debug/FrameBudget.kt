 ...
 *
 * A [uk.wildware.composegl.ui.host.UiRenderer] keeps one and fills it in, so a game that draws its interface
...
class FrameBudget(
    ...
    /** Times the Compose runtime's own work: everything [uk.wildware.composegl.ui.host.UiHost.frame] does. */
     ...
     *   [uk.wildware.composegl.ui.graphics.UiCanvas.drawCalls] is where it comes from.
