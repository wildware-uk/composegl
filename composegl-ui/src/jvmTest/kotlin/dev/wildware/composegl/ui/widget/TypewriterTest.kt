...
class TypewriterTest {
    ...
    fun `an effect moves and colours each character on its own`() {
        val shifted = TypewriterEffect { character ->
            ...
            character.colour = dev.wildware.composegl.ui.graphics.Colour.argb(0xFF00FF00)
        }
        lateinit var line: TypewriterState
        show {
        ...
        assertTrue(drawn.all { it.colour == dev.wildware.composegl.ui.graphics.Colour.argb(0xFF00FF00) })
    }
