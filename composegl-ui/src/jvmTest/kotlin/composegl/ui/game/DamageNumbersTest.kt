...
class DamageNumbersTest {
    ...
    private val canvas = RecordingCanvas(composegl.ui.geometry.Rect(0f, 0f, 800f, 600f))
    ...
    private fun frame(millis: Long = 16L) {
        ...
        host.frame(wall)
        canvas.clear(composegl.ui.geometry.Rect(0f, 0f, 800f, 600f))
    ...
    private class Silent : composegl.ui.graphics.UiCanvas {
        override fun rect(rect: composegl.ui.geometry.Rect, colour: composegl.ui.graphics.Colour, corner: Float) = Unit
        override fun border(rect: composegl.ui.geometry.Rect, colour: composegl.ui.graphics.Colour, width: Float, corner: Float) = Unit
        override fun shadow(rect: composegl.ui.geometry.Rect, colour: composegl.ui.graphics.Colour, spread: Float, corner: Float) = Unit
        override fun fan(points: FloatArray, colour: composegl.ui.graphics.Colour) = Unit
        override fun text(layout: composegl.ui.text.TextLayout, x: Float, y: Float, colour: composegl.ui.graphics.Colour) = Unit
        override fun image(
            texture: composegl.ui.graphics.TextureHandle,
            destination: composegl.ui.geometry.Rect,
            tint: composegl.ui.graphics.Colour,
            source: composegl.ui.geometry.Rect?,
        ) = Unit
        override fun pushClip(rect: composegl.ui.geometry.Rect) = Unit
