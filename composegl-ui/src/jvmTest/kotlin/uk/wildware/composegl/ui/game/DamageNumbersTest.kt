...
class DamageNumbersTest {
    ...
    private val canvas = RecordingCanvas(uk.wildware.composegl.ui.geometry.Rect(0f, 0f, 800f, 600f))
    ...
    private fun frame(millis: Long = 16L) {
        ...
        host.frame(wall)
        canvas.clear(uk.wildware.composegl.ui.geometry.Rect(0f, 0f, 800f, 600f))
    ...
    private class Silent : uk.wildware.composegl.ui.graphics.UiCanvas {
        override fun rect(rect: uk.wildware.composegl.ui.geometry.Rect, colour: uk.wildware.composegl.ui.graphics.Colour, corner: Float) = Unit
        override fun border(rect: uk.wildware.composegl.ui.geometry.Rect, colour: uk.wildware.composegl.ui.graphics.Colour, width: Float, corner: Float) = Unit
        override fun shadow(rect: uk.wildware.composegl.ui.geometry.Rect, colour: uk.wildware.composegl.ui.graphics.Colour, spread: Float, corner: Float) = Unit
        override fun fan(points: FloatArray, colour: uk.wildware.composegl.ui.graphics.Colour) = Unit
        override fun text(layout: uk.wildware.composegl.ui.text.TextLayout, x: Float, y: Float, colour: uk.wildware.composegl.ui.graphics.Colour) = Unit
        override fun image(
            texture: uk.wildware.composegl.ui.graphics.TextureHandle,
            destination: uk.wildware.composegl.ui.geometry.Rect,
            tint: uk.wildware.composegl.ui.graphics.Colour,
            source: uk.wildware.composegl.ui.geometry.Rect?,
        ) = Unit
        override fun pushClip(rect: uk.wildware.composegl.ui.geometry.Rect) = Unit
