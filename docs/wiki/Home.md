...
| **[[Debugging]]** | overlays for layout, focus, overdraw, draw calls, redraws and text, an inspector, and a drop-down console for typing commands, from `composegl-debug` |
