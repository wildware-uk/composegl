...
| **[[Widgets]]** | everything that ships in the toolkit: text, buttons, fields, collapsing headers, splitters, spinners, lists, tables, tooltips |
...
| **[[Debugging]]** | overlays for layout, focus, overdraw, draw calls, redraws and text, and an inspector, from `composegl-debug` |
