...
| **[[Debugging]]** | floating windows that tune your own values while the game runs, overlays for layout, focus, overdraw, draw calls, redraws and text, an inspector, a browsable tree of the whole screen, and a drop-down console for typing commands, from `composegl-debug` |
