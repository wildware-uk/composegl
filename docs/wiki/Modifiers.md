...
The receiver is a [`UiCanvas`](https://github.com/wildware-uk/composegl/blob/master/composegl-ui/src/commonMain/kotlin/uk/wildware/composegl/ui/graphics/UiCanvas.kt)
