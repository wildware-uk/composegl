...
| `composegl-game` | the game widgets: bars, reticle, damage numbers, world markers, cooldowns, hotbar, radial menus, minimap, compass bar, notifications, particles. Optional |
...
| [Game widgets](docs/wiki/Game-widgets.md) | health bars with a damage trail, a crosshair with spread and hit markers, damage numbers anchored in the world, nameplates and waypoints that follow points in the world, cooldowns, a hotbar, a weapon wheel, a minimap frame, a compass bar, notifications and particles, in the optional `composegl-game` module |
