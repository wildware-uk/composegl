...
`Text`, `Image`, `Button`, `IconButton`, `Checkbox`, `RadioButton`, `Toggle` and `Slider` ship with
the toolkit, and the example is built from them. Scrolling, lists and dialogues are next.
