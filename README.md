...
| `composegl-game` | the game widgets: bars, reticle, hit markers, damage direction arcs, a low-health vignette, damage numbers, world markers, cooldowns, hotbar, radial menus, inventory grid, minimap, compass bar, dialogue, skill trees, notifications, subtitles, item cards, particles. Optional |
