...
import uk.wildware.composegl.showcase.ui.HoloScreen
import uk.wildware.composegl.showcase.ui.ShowcaseUi
import uk.wildware.composegl.showcase.world.HoloStand
import uk.wildware.composegl.showcase.world.Particles
import uk.wildware.composegl.showcase.world.Scene3D
...
class Showcase : ApplicationAdapter() {
    ...
    private fun pretendPointerIsAt(where: String) {
        ...
        input.onPointer(uk.wildware.composegl.ui.input.PointerEvent.Move(uk.wildware.composegl.ui.input.PointerId.Mouse, uk.wildware.composegl.ui.geometry.Offset(x, y)))
        if (parts.size > 2 && parts[2].trim() == "press") {
            input.onPointer(uk.wildware.composegl.ui.input.PointerEvent.Press(uk.wildware.composegl.ui.input.PointerId.Mouse, uk.wildware.composegl.ui.geometry.Offset(x, y)))
        }
    }
